...
func TestCreateEtcdCluster(t *testing.T) {
	nodes, releasePorts := testClusterNodes(t, "etcd1", "etcd2", "etcd3", "etcd4")
...
func TestEtcdAssignmentsPauseResume(t *testing.T) {
	nodes, releasePorts := testClusterNodes(t, "etcd1")
	node := nodes[0]
	config := Config{}
	config.AddNode(node)
...
func TestEtcdAssignmentsPauseResumeWithoutClient(t *testing.T) {
	nodes, _ := testClusterNodes(t, "etcd2")
	node := nodes[0]
	config := Config{}
	config.AddNode(node)
...
func TestEtcdAssignmentsPauseResumeMultiNode(t *testing.T) {
	nodes, releasePorts := testClusterNodes(t, "etcd1", "etcd2")
